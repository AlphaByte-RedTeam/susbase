        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {highValueTargets.docs.map((brand: any) => (
              <a
                key={brand.id}
                href={`https://${brand.official_domain}`}
                target="_blank"
                rel="noopener noreferrer"
                className="border-2 border-primary/40 bg-primary/2 p-6 flex flex-col justify-between group hover:border-primary/60 transition-colors relative overflow-hidden"
              >
                ...
                <div className="space-y-2 relative z-10">
                  <div className="flex items-center gap-2">
                    <span className="text-lg font-bold tracking-tight uppercase text-foreground group-hover:text-primary transition-colors">
                      {brand.name}
                    </span>
                    <Badge
                      variant="default"
                      className="bg-primary text-primary-foreground rounded-none text-[10px] uppercase h-4 px-1"
                    >
                      Official
                    </Badge>
                  </div>
                  ...
                  safeUrls.docs.map((urlDoc: any) => (
                    ...
                    >
                      ...
                      <TableCell className="py-4">
                        <div className="flex items-center gap-2 text-green-600 dark:text-green-400 text-[10px] uppercase tracking-widest">
                          <ShieldCheck className="w-3 h-3" />
                          Verified Safe
                        </div>
                      </TableCell>
                      <TableCell className="py-4 text-right font-mono font-bold text-green-600 dark:text-green-400">
